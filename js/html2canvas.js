...
var Color = function () {
    ...
    _createClass(Color, [{
        ...
        value: function rgb2hsl() {
            ...
            var d = M - m;
            if (d == 0) h = 0;else if (M == this.r) h = (this.g - this.b) / d % 6;else if (M == this.g) h = (this.b - this.r) / d + 2;else h = (this.r - this.g) / d + 4;
            h *= 60;
            if (h < 0) h += 360;
            this.r = h;
            l = (M + m) / 2;
            if (d == 0) this.g = 0;else this.g = d / (1 - Math.abs(2 * l - 1)) * 100;
            this.b = l * 100;
            this.isHSL = true;
            this.isRGB = false;
        }
        ...
        value: function rgb2hsv() {
            ...
            var C = M - m;
            var h, s;
            if (C == 0) h = 0;else if (M == this.r) h = (this.g - this.b) / C % 6;else if (M == this.g) h = (this.b - this.r) / C + 2;else h = (this.r - this.g) / C + 4;
            h *= 60;
            if (h < 0) h += 360;
            this.r = h;
            //var v = M;
            if (M == 0) this.g = 0;else this.g = C / M * 100;
            this.b = M * 100;
            this.isHSV = true;
            this.isRGB = false;
        }
        ...
        key: 'blend',
        value: function blend(color, opacity) {
        ...
        key: 'brightnessRGB',
        value: function brightnessRGB(value) {
        ...
        key: 'adjustBrightnessRGB',
        value: function adjustBrightnessRGB(value) {
            if (value < 0) value = 0;
            if (this.isCMYK) {
                this.cmyk2rgb();
        ...
        key: 'contrastRGB',
        value: function contrastRGB(value) {
        ...
        key: 'grayscaleRGB',
        value: function grayscaleRGB(value, mode) {
            var gray = 0;
        ...
        key: 'grayscale',
        value: function grayscale(value, mode) {
            if (this.isCMYK) {
                this.cmyk2rgb();
        ...
        key: 'sepiaRGB',
        value: function sepiaRGB(value) {
            this.r = value * Math.min(255, this.r * 0.393 + this.g * 0.769 + this.b * 0.189 - this.r) + this.r;
            this.g = value * Math.min(255, this.r * 0.349 + this.g * 0.686 + this.b * 0.168 - this.g) + this.g;
            this.b = value * Math.min(255, this.r * 0.272 + this.g * 0.534 + this.b * 0.131 - this.b) + this.b;
        }
    }, {
        key: 'adjustSepia',
        value: function adjustSepia(value) {
            if (value < 0) value = 0;else if (value > 1) value = 1;
            if (this.isRGB) {
                this.sepiaRGB(value);
            } else if (this.isCMYK) {
...
var _letterSpacing = __webpack_require__(38);

var _lineBreak = __webpack_require__(39);

var _listStyle = __webpack_require__(8);

var _margin = __webpack_require__(40);

var _overflow = __webpack_require__(41);
...
var _textShadow = __webpack_require__(42);
...
var _wordBreak = __webpack_require__(45);

var _zIndex = __webpack_require__(46);
...
var NodeContainer = function () {
    function NodeContainer(node, parent, resourceLoader, index) {
        ...
        this.style = {
            ...
            display: display,
            filter: (0, _Filter.parseFilter)(style.filter || style.webkitFilter),
...
var CanvasRenderer = function () {
    ...
    _createClass(CanvasRenderer, [{
        ...
        key: 'drawImage',
        value: function drawImage(image, source, destination, filter) {
            ...
            if (typeof filter !== 'undefined') {
                ...
                var imageData = this.ctx.getImageData(destination.left, destination.top, destination.width, destination.height);
                ...
                for (var _j = 0; _j < imageData.height; _j++) {
                    for (var _i = 0; _i < imageData.width; _i++) {
                        ...
                        var c = _Color2.default.create([red, green, blue, alpha]);
...
var _Circle = __webpack_require__(51);
...
var _cssLineBreak = __webpack_require__(47);
...
var _LineBreak = __webpack_require__(48);
...
var _Trie = __webpack_require__(49);

var _linebreakTrie = __webpack_require__(50);
                    ...
                    if (_image) {
                        ...
                        if (_width > 0 && _height > 0) {
                            _this.target.clip([(0, _Bounds.calculatePaddingBoxPath)(container.curvedBounds)], function () {
                                _this.target.drawImage(_image, new _Bounds.Bounds(0, 0, _width, _height), contentBox, container.style.filter);
                            });
                        }
                    }
                }
...
var _Angle = __webpack_require__(54);
